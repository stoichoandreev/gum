package uk.gum.advert.view_models;
...
public class AdvertDetailsViewData extends BaseObservable {
    ...
    private AdvertDetailsViewData(Builder builder) {
        ...
        image = images != null && images.isEmpty() ? images.get(0) : DEFAULT_VALUE;
    }
    ...
    public static AdvertDetailsViewData fromApiResponse(AdvertDetails rawAdvertData) {
        if (rawAdvertData == null) return null;
        return new Builder()
                .id(rawAdvertData.getId())
                .title(rawAdvertData.getTitle())
                .price(rawAdvertData.getPrice())
                .address(rawAdvertData.getAddress())
                .date(rawAdvertData.getDate())
                .fuelType(rawAdvertData.getFuelType())
                .contactNumber(rawAdvertData.getContactNumber())
                .contactName(rawAdvertData.getContactName())
                .description(rawAdvertData.getDescription())
                .images(rawAdvertData.getImages())
                .build();
    }
